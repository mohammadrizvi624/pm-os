# CLAUDE.md — PM OS (development)

Instructions for **developing the plugins in this repo**. This is the PM OS *marketplace* — a distribution of product-management plugins — **not** a work project. Don't add a filled-in `company-context/` or product work here; this repo only ships generic, company-agnostic plugins.
...
## Adding a plugin
1. Create `<plugin>/.claude-plugin/plugin.json` (`name`, `version`, `description`, `author`, `category`), plus `skills/`, `commands/`, `README.md`.
